...
class Vrsta(Tabela):
    ...
    def dodaj_vrstico(self, **podatki):
        """
        Dodaj vrsto.
        Če vrsta že obstaja, vrne obstoječi ID.
        Argumenti:
        - poimenovani parametri: vrednosti v ustreznih stolpcih
        """
...
class Namen(Tabela):
    ...
    def dodaj_vrstico(self, **podatki):
        """
        Dodaj namen.
        Če namen že obstaja, vrne obstoječi ID.
        Argumenti:
        - poimenovani parametri: vrednosti v ustreznih stolpcih
        """
        assert "naziv" in podatki
...
class PripadaVrsta(Tabela):
    ...
    def dodaj_vrstico(self, **podatki):
        """
        Dodaj pripadnost lokacije in pripadajoče vrste.
        Argumenti:
...
class PripadaNamen(Tabela):
    ...
    def dodaj_vrstico(self, **podatki):
        """
        Dodaj pripadnost lokacije in pripadajoči namen.
        Argumenti:
        - podatki: slovar s podatki o pripadnosti
        """
        if podatki.get("naziv", None) is not None:
